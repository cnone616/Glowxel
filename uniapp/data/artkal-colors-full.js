...
const ARTKAL_COLORS_FULL = [
  ...
  { code: 'B20', name: '淡绿', hex: '#C2F0CC', group: '2' },
  { code: 'B21', name: '深青', hex: '#156A6B', group: '2' },
  { code: 'B22', name: '暗青', hex: '#0B3C43', group: '2' },
  { code: 'B23', name: '深绿灰', hex: '#303A21', group: '2' },
  { code: 'B24', name: '亮绿黄', hex: '#EEFCA5', group: '2' },
  { code: 'B25', name: '深蓝绿', hex: '#4E846D', group: '2' },
  { code: 'B26', name: '土黄绿', hex: '#8D7A35', group: '2' },
  { code: 'B27', name: '淡绿', hex: '#CCE1AF', group: '2' },
  { code: 'B28', name: '亮绿', hex: '#9EE5B9', group: '2' },
  { code: 'B29', name: '淡黄绿', hex: '#C5E254', group: '2' },
  { code: 'B30', name: '浅黄绿', hex: '#E2FCB1', group: '2' },
  { code: 'B31', name: '浅绿', hex: '#B0E792', group: '2' },
  { code: 'B32', name: '淡绿', hex: '#9CAB5A', group: '2' },
  // C 系列
  { code: 'C1', name: '嫩绿', hex: '#E8FFE7', group: '3' },
  { code: 'C2', name: '冰蓝', hex: '#A9F9FC', group: '3' },
  { code: 'C3', name: '浅蓝', hex: '#A0E2FB', group: '3' },
  { code: 'C4', name: '亮蓝', hex: '#41CCFF', group: '3' },
  { code: 'C5', name: '天蓝', hex: '#01ACEB', group: '3' },
  { code: 'C6', name: '淡蓝', hex: '#50AAF0', group: '3' },
  { code: 'C7', name: '中蓝', hex: '#3677D2', group: '3' },
  { code: 'C8', name: '深蓝', hex: '#0F54C0', group: '3' },
  { code: 'C9', name: '宝蓝', hex: '#324BCA', group: '3' },
  { code: 'C10', name: '湖蓝', hex: '#3EBCE2', group: '3' },
  { code: 'C11', name: '青蓝', hex: '#28DDDE', group: '3' },
  { code: 'C12', name: '深靛蓝', hex: '#1C334D', group: '3' },
  { code: 'C13', name: '浅天蓝', hex: '#CDE8FF', group: '3' },
  { code: 'C14', name: '冰天蓝', hex: '#D5FDFF', group: '3' },
  { code: 'C15', name: '青绿蓝', hex: '#22C4C6', group: '3' },
  { code: 'C16', name: '深蓝', hex: '#1557A8', group: '3' },
  { code: 'C17', name: '亮青蓝', hex: '#04D1F6', group: '3' },
  { code: 'C18', name: '深海蓝', hex: '#1D3344', group: '3' },
  { code: 'C19', name: '青蓝', hex: '#1887A2', group: '3' },
  { code: 'C20', name: '深蓝', hex: '#176DAF', group: '3' },
  { code: 'C21', name: '淡蓝', hex: '#BEDDFF', group: '3' },
  { code: 'C22', name: '青灰', hex: '#67B4BE', group: '3' },
  { code: 'C23', name: '浅蓝', hex: '#C8E2FF', group: '3' },
  { code: 'C24', name: '亮蓝', hex: '#7CC4FF', group: '3' },
  { code: 'C25', name: '青蓝', hex: '#A9E5E5', group: '3' },
  { code: 'C26', name: '中蓝', hex: '#3CAED8', group: '3' },
  { code: 'C27', name: '浅蓝', hex: '#D3DFFA', group: '3' },
  { code: 'C28', name: '灰蓝', hex: '#BBCFED', group: '3' },
  { code: 'C29', name: '深蓝', hex: '#34488E', group: '3' },
  // D 系列
  { code: 'D1', name: '淡紫', hex: '#AEB4F2', group: '4' },
  { code: 'D2', name: '蓝紫', hex: '#858EDD', group: '4' },
  { code: 'D3', name: '中蓝', hex: '#2F54AF', group: '4' },
  { code: 'D4', name: '深蓝', hex: '#182A84', group: '4' },
  { code: 'D5', name: '紫蓝', hex: '#B843C5', group: '4' },
  { code: 'D6', name: '淡紫', hex: '#AC7BDE', group: '4' },
  { code: 'D7', name: '深紫', hex: '#8854B3', group: '4' },
  { code: 'D8', name: '浅紫', hex: '#E2D3FF', group: '4' },
  { code: 'D9', name: '紫粉', hex: '#D5B9F8', group: '4' },
  { code: 'D10', name: '深紫', hex: '#361851', group: '4' },
  { code: 'D11', name: '淡紫', hex: '#B9BAE1', group: '4' },
  { code: 'D12', name: '粉紫', hex: '#DE9AD4', group: '4' },
  { code: 'D13', name: '玫紫', hex: '#B90095', group: '4' },
  { code: 'D14', name: '紫红', hex: '#8B279B', group: '4' },
  { code: 'D15', name: '深蓝紫', hex: '#2F1F90', group: '4' },
  { code: 'D16', name: '灰紫', hex: '#E3E1EE', group: '4' },
  { code: 'D17', name: '淡蓝紫', hex: '#C4D4F6', group: '4' },
  { code: 'D18', name: '紫', hex: '#A45EC7', group: '4' },
...
// 导出ß
export { ARTKAL_COLORS_FULL, ARTKAL_OFFICIAL_SETS, ARTKAL_PRESETS, getColorByCode };