const DEMO_ITEMS = [
  ...
  { id: "metablob", label: "流体团块", category: "经典屏保", type: "ambient", ambientPreset: "metablob", source: "AmbientScenes/Metablob", hint: "上游 AmbientScenes 的 Metablob 场景" },
  ...
  { id: "maze", label: "迷宫漫游", category: "游戏屏保", type: "animation", source: "GameScenes/Maze", hint: "上游 GameScenes 的 Maze 场景" },
  { id: "ping_pong", label: "像素乒乓", category: "游戏屏保", type: "animation", source: "GameScenes/PingPong", hint: "上游 GameScenes 的 PingPong 场景" },
  { id: "snake", label: "贪吃蛇", category: "游戏屏保", type: "animation", source: "GameScenes/Snake", hint: "上游 GameScenes 的 Snake 场景" },
...
const GAME_SCREENSAVER_DEMO_IDS = [
  "maze",
  "ping_pong",
  "snake",
];
...
function getGameScreensaverDemoItems() {
  return GAME_SCREENSAVER_DEMO_IDS.map((id) => resolveDemoById(id)).filter(Boolean);
}

export {
  DEMO_ITEMS,
  GAME_SCREENSAVER_DEMO_IDS,
