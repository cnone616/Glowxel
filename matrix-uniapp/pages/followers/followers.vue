      ...
      <view v-else class="followers-list">
        ...
        >
          ...
          <view class="follower-actions">
            ...
            <button class="message-btn" @click.stop="sendMessage(follower)">
...
.follow-btn, .following-btn, .message-btn {
  display: flex;
  align-items: center;
  gap: 8rpx;
  padding: 16rpx 24rpx;
...
.follow-btn::after, .following-btn::after, .message-btn::after {
  border: none;
}
...
.following-btn:active, .message-btn:active {
  background-color: var(--border-primary);
  transform: scale(0.95);
}
