...
import { AssetWorkerBridge } from '../../editor/core/assetWorkerBridge'
...
export function UploadDialog() {
  ...
  return (
    <Dialog.Root
      open={open}
      onOpenChange={(nextOpen) => commandBus.execute({ type: 'session.setUploadDialogOpen', open: nextOpen })}
    >
      <Dialog.Portal>
